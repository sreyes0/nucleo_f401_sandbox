...
default interrupt handlers or the `SysTick\_Handler`. Per default the vector
table points them to the `Default\_Handler` (defined in the same file) unless 
